...
DEFINE_bool(visualize_mesh_in_frustum, true,
...
bool Visualizer3D::visualize(const VisualizerInputPayload& input,
  ...
  switch (visualization_type_) {
    ...
    case VisualizationType::MESH2D: {
        std::cout << "VisualizationType::MESH2D" << std::endl;
    ...
    case VisualizationType::
        MESH2Dsparse: {  // visualize a 2D mesh of (right-valid) keypoints
                         ...
                         // obstacles
      std::cout << "VisualizationType::MESH2Dsparse" << std::endl;
    ...
    case VisualizationType::MESH2DTo3Dsparse: {
        std::cout << "VisualizationType::MESH2DTo3Dsparse" << std::endl;
      ...
      LOG(INFO) << "Starting 3D mesh visualization..." << std::endl;
      ...
      if (FLAGS_visualize_mesh) {
        ...
        if (FLAGS_visualize_semantic_mesh) {
          ...
          LOG(INFO) << "Visualize mesh with colored clusters.";
      ...
      if (FLAGS_visualize_point_cloud) {
          LOG(INFO) << "FLAGS_visualize_point_cloud";
